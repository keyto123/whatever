...
void average_stats() {
	...
	// }
	// printf("t1 stats: HP:%d/%d\nStats: %d %d %d %d %d\n", t1.stats.hp, t1.stats.max_hp, t1.stats.attack, t1.stats.defense, t1.stats.hit, t1.stats.evade, t1.stats.critical);
	printf("level: %d\n", t1.stats.level);
